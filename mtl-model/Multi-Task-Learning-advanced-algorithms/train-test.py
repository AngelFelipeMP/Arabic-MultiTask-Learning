...
class CrossValidation(MetricTools, StatisticalTools):
    ...
    def calculate_metrics(self, output_train, average='macro'):
        ...
        for head in self.heads:
            # macro average
            metrics_dict[head]['f1'] = metrics.f1_score(output_train[head]['targets'], output_train[head]['predictions'], average='binary')
            metrics_dict[head]['acc'] = metrics.accuracy_score(output_train[head]['targets'], output_train[head]['predictions'])
            metrics_dict[head]['recall'] = metrics.recall_score(output_train[head]['targets'], output_train[head]['predictions'], average='binary') 
            metrics_dict[head]['precision'] = metrics.precision_score(output_train[head]['targets'], output_train[head]['predictions'], average='binary')
            
            metrics_dict[head]['f1_weighted'] = metrics.f1_score(output_train[head]['targets'], output_train[head]['predictions'], average=average)
            metrics_dict[head]['recall_weighted'] = metrics.recall_score(output_train[head]['targets'], output_train[head]['predictions'], average=average) 
            metrics_dict[head]['precision_weighted'] = metrics.precision_score(output_train[head]['targets'], output_train[head]['predictions'], average=average)
