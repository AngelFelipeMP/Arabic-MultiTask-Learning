...
if __name__ == "__main__":
    ...
    # rename_logs(term='cross-validation') -> ##DEBUG: CODE ADATPTATION

    # create progress bar
    grid_search_bar = tqdm(total=tdqm_gridsearch(), desc='GRID SEARCH', position=0)

    # metric results dataset
    # df_results = None -> ##DEBUG: CODE ADATPTATION
    df_results = pd.read_csv('/home/adepau/repos/Arabic-MultiTask-Learning/mtl-model/logs' + '/cross-validation.csv')
